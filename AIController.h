...
public:
    ...
    /*
     ...
     playerBoard  Поле игрока
     shots        Сетка выстрелов ИИ
     playerTurn   Флаг хода игрока
     playerWon    Флаг победы игрока
...
private:
    /*
     Помечает все клетки вокруг попадания как недоступные для стрельбы.
    ...
    /*
     Добавляет допустимые соседние клетки вокруг попадания
    ...
    /*
     Обрабатывает попадание по кораблю и обновляет состояние ИИ.
    ...
    /*
     Сортирует список попаданий вдоль текущего направления dx/dy.
    ...
    /*
     Сбрасывает направление и пересобирает цели вокруг всех попаданий.
